...
**Instructors:** [Srikanta Bedathur](https://www.cse.iitd.ac.in/~srikanta/)
...
## Contents
* Sparse models for retrieval (Boolean, vector-space, probabilistic, language-model, Markov random fields, diversity-aware); 
...
* Use of LLMs in retrieval and evaluation;
* Agentic IR
...
* comfort with programming in Java/C++/Python, and with linear algebra.
